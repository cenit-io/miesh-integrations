...
* Complete the fields of the form with the following information or those corresponding to your business:
    ...
    >- **Name**: connection-sfapi
    >- **Url**: https://api2.successfactors.eu/sfapi/v1
...
### Add new connection
   ...
   ![](../assets/snapshots/sap-sf-conn/snapshots-007.png)
   ![](../assets/snapshots/sap-sf-conn/snapshots-008.png)
   ![](../assets/snapshots/sap-sf-conn/snapshots-009.png)
